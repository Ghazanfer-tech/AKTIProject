...
@section('content')
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <form id='1' action="{{ route('web-placeorder') }}" method=post>
                @csrf
                <div class="row g-5">
                    ...
                    <div class="col-md-12 col-lg-6 col-xl-5">
                        <div class="table-responsive" href="{route{('web-cart')}}">
                            <table class="table">
                                <thead>
                                    <tr>
                                    ...
                                    @if (session('cart'))
                                        @foreach (session('cart') as $id => $details)
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <p class="mb-0 mt-4">2.99 $</p> -->
                                                    <p class="mb-0 mt-4">{{ $details['quantity'] }}</p>
                                                </td>
                                                <td>
                                                    <!-- <p class="mb-0 mt-4">2.99 $</p> -->
                                                    <p class="mb-0 mt-4">{{ $details['quantity'] * $details['price'] }}</p>
                                                </td>
                                                <!-- <td> -->
                                                <!-- <p class="mb-0 mt-4">2.99 $</p> -->
                        ...
                        <tr>
                            ...
                            <!-- </th> -->
                            <!-- <td class="py-5">/ -->
                            <!-- <p class="mb-0 text-dar/k text-uppercase py-3">TOTAL</p> -->
                            <!-- </td> -->
                            <!-- <td class="py-5"></td> -->
                            <!-- <td class="py-5"></td> -->
                            <!-- <td class="py-5"> -->
                ...
                <!-- <div class="row g-4 text-center align-items-center justify-content-center border-bottom py-3">
                            <div class="col-12">
                                <div class="form-check text-start my-3">
                                    ...
                                    <label class="form-check-label" for="Deliverys-1">Cash On Delivery</label>
                                </div>
                            </div>
                        </div> -->
                <!-- <div class="row g-4 text-center align-items-center justify-content-center border-bottom py-3">
