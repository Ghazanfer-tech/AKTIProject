            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        ...
                        <div
                            class="bg-success rounded-circle bor    der border-2 border-white position-absolute end-0 bottom-0 p-1">
                        </div>
                    </div>
                    <div class="ms-3">
                        <h6 class="mb-0">ghazanfer</h6>
                        <span>Admin</span>
                    </div>
                </div>
                {{-- <div class="navbar-nav w-100"> --}}
                    ...
                    {{-- <div class="ms-5 mt-3 font-bold"><a style="text-decoration: none ;" href="{{route('admin-products-index')}}">Products</a></div> --}}

                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <div class="parent " style="display: flex;">
                                <div class="micon border"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                                        viewBox="0 -960 960 960" width="24px" fill="#009cff">
                                        <path
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-light rounded p-4">
                            ...
                            <div class="d-flex align-items-center border-bottom py-3">
                                {{-- <img class="rounded-circle flex-shrink-0" src="{{asset('/dashmin/img/user.jpg')}}" alt="" --}}
                                    style="width: 40px; height: 40px;">
